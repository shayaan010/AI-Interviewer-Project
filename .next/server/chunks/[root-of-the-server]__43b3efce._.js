...
"[project]/.next-internal/server/app/api/user/recordings-mongodb/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/user/recordings-mongodb/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const recordings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$voiceDataServiceMongoDB$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getUserRecordings(user.id, 50);
        ...
        const sanitizedRecordings = recordings.map((recording)=>({
                ...
                rec_length: recording.rec_length || 0,
...
async function POST(request) {
    try {
        ...
        const recordingId = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$voiceDataServiceMongoDB$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].storeVoiceRecording(user.id, interviewId, audioBuffer, {
...
async function DELETE(request) {
    try {
        ...
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$voiceDataServiceMongoDB$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].deleteVoiceRecording(recordingId, user.id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__43b3efce._.js.map