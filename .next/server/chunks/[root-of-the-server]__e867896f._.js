...
"[project]/.next-internal/server/app/api/get-completed-interviews/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/get-completed-interviews/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const completedInterviews = await db.collection('completed_interviews').find({
            userId: user.id
        }).sort({
            createdAt: -1
        }) // Most recent first
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e867896f._.js.map